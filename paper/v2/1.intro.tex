...
\begin{tikzpicture}[
    font=\footnotesize,
    hub/.style={rounded corners=4pt, draw=blue!60, fill=blue!10, line width=0.9pt,
                align=center, inner sep=7pt, minimum width=3.4cm, minimum height=1.5cm},
    leaf/.style={rounded corners=3pt, draw=black!45, fill=black!4, line width=0.6pt,
                 align=center, inner sep=5pt, minimum width=3.1cm, minimum height=1.1cm},
    link/.style={-{Latex[length=2.2mm]}, draw=blue!45, line width=0.7pt}
]
...
\begin{tikzpicture}[
    ...
    stage/.style={rounded corners=3pt, draw=black!50, fill=black!4, line width=0.6pt,
    ...
    nn/.style={rounded corners=3pt, draw=teal!60, fill=teal!12, line width=0.8pt,
               align=center, inner sep=5pt, text width=2.5cm, minimum height=1.3cm},
    outbox/.style={rounded corners=3pt, draw=blue!60, fill=blue!12, line width=0.8pt,
                align=center, inner sep=5pt, text width=2.8cm, minimum height=1.3cm},
    chip/.style={rounded corners=2pt, draw=black!40, fill=orange!10, line width=0.5pt,
                 align=center, inner sep=4pt, text width=2.8cm, font=\scriptsize, minimum height=1.0cm},
    flow/.style={-{Latex[length=2.4mm]}, line width=0.8pt, draw=black!65}
]
