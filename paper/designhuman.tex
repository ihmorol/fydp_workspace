...
This chapter lays out how we designed the experiment. You will see the requirements our pipeline needs to meet, the context it operates in, the two-phase methodology we use for architecture search and optimizer comparison, and the project plan with task ownership across the team.
...
The functional requirements tell you what the pipeline does at each stage, from generating the reference solution to producing the final comparison report. The nonfunctional requirements set the quality bar. Reproducibility and reference accuracy are the two strictest constraints.
